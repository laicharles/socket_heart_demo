...
public class SocketClient
{
    ...
    public SocketClient(String ip, int port,String id)
    {
        try
        {
            this.ip = ip;
    ...
    {
        SocketClient client1 = new SocketClient("127.0.0.1", 8020, "1");
        ...
        SocketClient client2 = new SocketClient("127.0.0.1", 8020, "2");
    }
}